...
/**************************** FOR OTA **************************************************/
#define SENSORNAME "TV Cabinet" //change this to whatever you want to call your device
#define OTApassword "[REDACTED]" //the password you will need to enter to upload remotely via the ArduinoIDE
int OTAport = 8266;
